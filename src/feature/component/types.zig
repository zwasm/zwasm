...
/// that mint an instance index (`Binary.md`) has its own variant, carrying the
/// index of the entry that minted it, so resolving an instance index is one
...
pub const TypeInfo = struct {
    ...
    /// terminating on unvalidated input).
