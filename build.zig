...
pub fn build(b: *std.Build) void {
    ...
    const conformance_cases = [_]struct {
        ...
        .{ .src = "test/c_api_conformance/module_imports_complete.c", .name = "module_imports_complete" }, // #475 every import is listed, tag included, or the _ex call says it is not
        .{ .src = "test/c_api_conformance/module_exports_tag.c", .name = "module_exports_tag" }, // #478 a tag export is listed at its position; wasm_instance_exports omits it
